...
import app.gyrolet.mpvrx.exoplayer.feature.player.extensions.brightnessPercentage
import app.gyrolet.mpvrx.exoplayer.feature.player.extensions.currentBrightness

@Composable
fun rememberBrightnessState(): BrightnessState {
    val activity = LocalActivity.current
    val brightnessState = remember { BrightnessState(activity as ExoPlayerActivity) }
